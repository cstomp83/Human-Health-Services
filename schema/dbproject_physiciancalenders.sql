...
CREATE TABLE `physiciancalenders` (
  ...
  KEY `ScheduleTypeID` (`ScheduleTypeID`),
  ...
  CONSTRAINT `physiciancalenders_ibfk_2` FOREIGN KEY (`ScheduleTypeID`) REFERENCES `scheduletypes` (`ScheduleTypeID`),
  CONSTRAINT `physiciancalenders_ibfk_3` FOREIGN KEY (`ClinicID`) REFERENCES `clinics` (`ClinicID`)
...
-- Dump completed on 2025-04-29 15:23:10
